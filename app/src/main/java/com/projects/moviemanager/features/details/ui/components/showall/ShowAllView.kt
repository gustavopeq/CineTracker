package com.projects.moviemanager.features.details.ui.components.showall
...
import com.projects.moviemanager.common.util.UiConstants.FOREGROUND_INDEX
...
private fun TopBar(
    ...
    val title = if (mediaType == MediaType.SHOW) {
        stringResource(id = R.string.see_all_shows_label)
    } else {
        stringResource(id = R.string.see_all_movies_label)
    }
